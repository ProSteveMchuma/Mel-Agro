        ...
        <div className="flex items-center gap-3 sm:gap-6 md:gap-8 justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4 md:gap-6 shrink-0">
            ...
            <div className="relative" ref={helpRef}>
              <button
                type="button"
                className="hidden lg:flex items-center gap-2 group rounded-xl text-left hover:text-[#22c55e] transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-green-600/20"
              ...
              {/* Help Dropdown Menu */}
              {isHelpOpen && (
                <div id="help-menu" className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 animate-in fade-in slide-in-from-top-2 z-50">
                  <Link
                    href="/help"
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-melagri-primary font-medium"
            ...
            {/* Cart */}
            <button type="button" onClick={toggleCart} aria-label={`Open cart${cartCount ? `, ${cartCount} item${cartCount === 1 ? "" : "s"}` : ""}`} className="flex items-center gap-2 group rounded-xl focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-green-600/20">
