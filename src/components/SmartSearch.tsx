...
export default function SmartSearch() {
    ...
    return (
        <div ref={wrapperRef} className="relative w-full md:w-80 lg:w-96 z-50">
            ...
            {isOpen && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-y-auto max-h-[60vh] md:max-h-[75vh] animate-in fade-in slide-in-from-top-2 duration-200 min-w-0 w-full md:min-w-[320px]">
