            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                >
                    <Image
                        ...
                        alt="New Arrivals: Agricultural Seeds and Farm Equipment at Mel-Agri Kenya"
                        fill
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-center">
                        ...
                        <Link href="/contact?subject=supplier" className="group relative bg-gray-900 text-white px-8 py-3 rounded-xl font-black text-[11px] uppercase tracking-widest w-fit overflow-hidden">
