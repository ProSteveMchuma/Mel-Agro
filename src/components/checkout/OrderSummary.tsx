        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                    ...
                    {appliedDiscount ? (
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-grow rounded-lg border-gray-300 focus:ring-melagri-primary focus:border-melagri-primary text-sm uppercase"
                                value={couponCode}
            ...
            <div className="mt-8 space-y-3">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-melagri-primary shadow-sm">
