...
export default function ProductForm({ initialData, onSubmit, isSubmitting, title }: ProductFormProps) {
    ...
    const addVariant = () => {
        setVariants([...variants, { id: Date.now().toString(), name: '', price: '', stockQuantity: '' }]);
    };
                        ...
                        {variants.length > 0 ? (
                            <div className="space-y-3">
                                {variants.map((variant, idx) => (
                                    <div key={variant.id} className="grid grid-cols-1 md:grid-cols-4 gap-3 bg-white p-3 rounded-xl border border-gray-100 shadow-sm items-end">
                                        <div>
                                            <label className="block text-[9px] font-black text-gray-400 uppercase mb-1">Name (e.g. 50kg)</label>
                                            <input
                                                type="text"
                                                value={variant.name}
                                        ...
                                        <div>
                                            <label className="block text-[9px] font-black text-gray-400 uppercase mb-1">Price (Optional)</label>
                                            <input
                                                type="number"
                                                value={variant.price}
                                        ...
                                        <button
                                            ...
                                            className="h-10 text-red-500 hover:bg-red-50 rounded-lg flex items-center justify-center transition-colors"
                                        >
