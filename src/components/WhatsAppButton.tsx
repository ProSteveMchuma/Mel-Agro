    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Main button */}
                <div
                    className="relative bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 flex items-center justify-center"
                >
                    <svg className="w-6 h-6 md:w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Tooltip */}
                    <div className="absolute right-full mr-6 top-1/2 -translate-y-1/2 bg-white text-gray-900 px-4 py-2 rounded-2xl shadow-2xl text-[11px] font-black uppercase tracking-widest whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity border border-gray-100 hidden md:block">
                        Need Help? Chat Now!
