      ...
      <main className="flex-grow w-full">
        <section className="container-custom mb-8 lg:hidden" aria-labelledby="mobile-categories-heading">
          <div className="mb-4 flex items-end justify-between px-2">
            <h2 id="mobile-categories-heading" className="text-lg font-black tracking-tighter text-gray-900">Shop by Category</h2>
        ...
        <section className="container-custom">
          <div className="overflow-hidden rounded-[3rem] border border-gray-100 bg-white p-2"><Hero /></div>
        </section>
