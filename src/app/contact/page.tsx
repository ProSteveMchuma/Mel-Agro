                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                        ...
                        <div className="bg-white rounded-2xl p-8 border border-gray-200">
                            ...
                            <form className="space-y-6">
                                ...
                                <button className="w-full bg-melagro-primary hover:bg-melagro-secondary text-white font-bold py-3 px-6 rounded-lg transition-colors">
                                    Send Message
                                </button>
                            </form>
                        </div>
                    ...
                    <div className="mt-16 bg-gradient-to-r from-melagro-primary to-melagro-secondary rounded-2xl p-12 text-white text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <button className="bg-white text-melagro-primary px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors">
                                💬 WhatsApp
                            </button>
