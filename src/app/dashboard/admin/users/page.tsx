                                ...
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3 p-2 -m-2 rounded-lg transition-colors group">
                                            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold text-xs group-hover:bg-melagro-primary group-hover:text-white transition-colors">
                                                {user.name.charAt(0)}
                                            </div>
                                            <div>
                                                <div className="font-medium text-gray-900 group-hover:text-melagro-primary transition-colors">{user.name}</div>
                                    ...
                                    <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                                        <select
                                            ...
                                            className={`text-xs font-bold px-3 py-1.5 rounded-xl border border-gray-100 shadow-sm focus:ring-2 focus:ring-melagro-primary/20 cursor-pointer transition-all hover:border-melagro-primary/30 outline-none ${user.role === 'admin' || user.role === 'super-admin' ? 'bg-purple-50 text-purple-700' : 'bg-blue-50 text-blue-700'
                                                }`}
                                        >
