...
export default async function CategoryPage({ params }: Props) {
    ...
    return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph) }} /><CatalogLandingPage eyebrow={editorial.eyebrow} title={category} summary={editorial.summary} products={products} guidance={editorial.guidance} faq={editorial.faq} relatedLinks={relatedLinks} filtersHref={`/products?category=${encodeURIComponent(category)}`} /></>;
}
